...
% Evaluate
VERBOSE = false;
% [mme, c, fp, m, g, d, alltracked, allfalsepos] = clearMOTMex_woldX_worldY(gtMat, resMat, threshold, world, VERBOSE);
[mme, c, fp, m, g, d, alltracked, allfalsepos] = clearMOTMex_woldX_worldY_worldZ(gtMat, resMat, threshold, world, VERBOSE);
