function [assignments,costs]= gibbswrap_jointpredupdt_custom(P0,m,p)
...
for sol= 2:m
    for var= 1:n1 % this is looping through all labels 
        tempsamp= exp(-P0(var,:)); %grab row of costs for current association variable (grab label by label)
